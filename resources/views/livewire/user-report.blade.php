<div>
    <form wire:submit.prevent="generateReports" class="w-full grid grid-cols-1 gap-y-1 sm:grid-cols-3" enctype="multipart/form-data">
        ...
        <div class="sm:col-span-1 px-1">
            <x-form-list-input-field name="monastery" id="monastery" :options="$monasteryList" wire:model.live="monastery" required/>
        </div>
        <div class="sm:col-span-1 px-1">
            <x-form-list-input-field name="position" id="position" :options="$positionList" wire:model.live="position" required/>
        </div>
        <div class="sm:col-span-1 px-1">
