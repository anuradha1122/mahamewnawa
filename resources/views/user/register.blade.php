    ...
    <div class="py-3">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="isolate bg-white px-6 py-10 sm:py-10 lg:px-8">
                ...
                <form method="POST" action="{{ route('user.register') }}" class="mx-auto mt-8 max-w-xl sm:mt-8" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <x-form-list-input-section size="sm:col-span-1" name="monastery" id="monastery" :options="$monasteries" label="Current Monastery" />
                        <x-form-list-input-section size="sm:col-span-1" name="position" id="position" :options="$positions" label="Current Position" />
                        <x-form-date-input-section size="sm:col-span-1" name="startDate" id="startDate" label="Start Date" />
                        <x-form-list-input-section size="sm:col-span-1" name="category" id="category" :options="$userCategories" label="User Category" />
